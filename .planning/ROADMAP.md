...
- [x] **Phase 3: Data Portability** — Export/Import backend endpoints + mode-aware wiring in App.tsx
- [x] **Phase 4: Snapshot System** — Snapshot API routes + minimal UI (create, list, compare) on Synthese page
...
Plans:
- [x] 03-01-PLAN.md — Backend portability router: GET /api/export + POST /api/import + Integration-Tests (PORT-01, PORT-02)
- [x] 03-02-PLAN.md — Frontend API: serverApi um exportAll/importAll erweitern (PORT-03)
- [x] 03-03-PLAN.md — App.tsx Verdrahtung: mode-aware exportJSON/importJSON + Buttons in beiden Modi (PORT-03, PORT-04)
...
Plans:
- [x] 04-01-PLAN.md — Failing test suite (RED gate): test_snapshots.py for SNAP-01, SNAP-02, SNAP-03
- [x] 04-02-PLAN.md — Backend implementation (GREEN gate): values v2 drift fix + snapshots.py router + main.py registration
- [x] 04-03-PLAN.md — Frontend API client: SnapshotMeta/SnapshotFull types + serverApi + localApi snapshot methods
- [x] 04-04-PLAN.md — Snapshot create form + chronological list in SyntheseModule.tsx (SNAP-04, SNAP-05)
- [x] 04-05-PLAN.md — Snapshot comparison delta view in SyntheseModule.tsx (SNAP-06)
...
| 3. Data Portability | 3/3 | Complete | 2026-04-22 |
| 4. Snapshot System | 5/5 | Complete | 2026-04-22 |
...
*Updated: 2026-04-22 — Phase 3 complete (3/3 plans done)*
*Updated: 2026-04-22 — Phase 4 complete (5/5 plans done) — milestone v1 complete*
